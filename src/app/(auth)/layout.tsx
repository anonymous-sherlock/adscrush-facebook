  ...
  return (
    <div className="grid min-h-screen grid-cols-1 overflow-hidden md:grid-cols-3 lg:grid-cols-2 grainy">
      <AspectRatio ratio={16 / 9}>
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent md:to-black/40" />
        <Link
          href="/"
      ...
      <main className="container -ml-2 min-[380px]:mx-auto absolute top-1/2 col-span-1 flex -translate-y-1/2 items-center md:static md:top-0 md:col-span-2 md:flex md:translate-y-0 lg:col-span-1">
        {children}
      </main>
    </div>
  )
